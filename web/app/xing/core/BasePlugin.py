...
from app.xing.core import PluginType, DEFAULT_PORT_SCHEME_LIST
from app.xing.utils import parse_target_info, get_logger, load_file
import socket
...
class BasePlugin:
    ...
    def do_brute(self):
        from app.xing.core import brute_runner
