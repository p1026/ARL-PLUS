...
def init_args():
    ...
    parser.add_argument('--version', '-V',
                        action='version', version='%(prog)s ' + app.xing.__version__)
...
from app.xing.core.const import PluginType, SchemeType, AppType, DEFAULT_PORT_SCHEME_LIST, SubParser
from app.xing.core.PluginRunner import plugin_runner
from app.xing.core.BruteRunner import brute_runner
from app.xing.core.ThreadMap import thread_map
